...
public class LekkerAdminCommand implements CommandExecutor {
    ...
    private void sendToolsHelp(CommandSender sender) {
        ...
        if (sender.hasPermission("lekkeradmin.invsee") || sender.hasPermission("lekkeradmin.admin")) {
            sender.sendMessage(plugin.lang().get("admin.tools.invsee", "&7/invsee <speler> &8- &bBekijk inventory van speler"));
        }

        if (sender.hasPermission("lekkeradmin.enderchest") || sender.hasPermission("lekkeradmin.admin")) {
            sender.sendMessage(plugin.lang().get("admin.tools.enderchest", "&7/enderchest <speler> &8- &bBekijk enderchest van speler"));
        }
        ...
        if (sender.hasPermission("lekkeradmin.vanish") || sender.hasPermission("lekkeradmin.admin")) {
            sender.sendMessage(plugin.lang().get("admin.tools.vanish", "&7/vanish, /v &8- &bToggle vanish mode"));
        }
        ...
        if (sender.hasPermission("lekkeradmin.maintenance") || sender.hasPermission("lekkeradmin.admin")) {
            sender.sendMessage(plugin.lang().get("admin.tools.maintenance", "&7/maintenance &8- &bToggle maintenance mode"));
        }
